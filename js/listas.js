// ===== RSVP =====
fetch('https://xv-isa-backend-production-36cf.up.railway.app/rsvp')
  .then(res => res.json())
  .then(data => {
...
// ===== Canciones =====
fetch('https://xv-isa-backend-production-36cf.up.railway.app/canciones/__listado_interno_xv_isa_2026')
  .then(res => res.json())
  .then(data => {
